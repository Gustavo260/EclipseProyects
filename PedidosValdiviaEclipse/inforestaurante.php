    ...
    <br />
    	<table border="0" bordercolordark="#000000" width="100%">
            <tr>
                ...
                <td width="20%" rowspan="2"><?php if($_SESSION){ ?><div class="carrito"><span><a title="Ver historial" onmouseover="this.style.opacity=0.5" onmouseout="this.style.opacity=1" href="procesos/historialpedidos.php?txtRestaurante=<?php echo $_GET['txtRestaurante']; ?>&estado=<?php echo $_GET['estado']; ?>"><img alt="Mis Reservas" src="recursos/historial2.png" width="45px" /></a></span></div><?php }?></td>
		...
		<script type="text/javascript">
			$(document).ready(function() {
				...
				$(".btnInfo").click(function(event) {
					event.preventDefault();
					$("#body").load('procesos/maps.php?restaurante=<?php echo $ID_Restaurante; ?>&lat=<?php echo $latRest; ?>&lon=<?php echo $lonRest; ?>').slideDown(1000);
					$("#body").css("visibility","visible");					
				});
