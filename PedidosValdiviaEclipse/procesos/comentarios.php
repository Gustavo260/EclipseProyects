         ...
         //Visualizar em Tela
           while($Linha = mysql_fetch_object($re)){
                  echo "<a href=''>
							...
							<table width='250' height='10' border='0' border='1'>
								<tr>
								
								<td style='margin-top:10px;' width='100'><center><img src='{$Linha->avatar}' onmouseover='this.style.opacity=0.5' onmouseout='this.style.opacity=1' width='75px' height='75px'></center></td>
									<td width='60%'>
										<table>
		  ...
		  echo '<textarea rows="5" cols="75" placeholder="Escribe tu comentario..."></textarea>';
