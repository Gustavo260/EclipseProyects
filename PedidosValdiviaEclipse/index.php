...
<!-- Cuerpo de la pagina -->
        ...
        <div class="buscador">
					...
					<?php if($_SESSION){ ?>
						...
						{
						?>
						  <a class="btn" style=" height:25px; width:100px;" href="procesos/pedidoslocal.php">Ver Pedidos <i class="fa fa-search"></i></a>
						  <a class="btn" style=" height:25px; width:100px;" href="procesos/reservaslocal.php">Ver Reservas <i class="fa fa-search"></i></a>
						<?php
						}
					}
					else
        ...
        <div>
        	<p class="seudofooter"><b>También para celulares!</b></p>
        </div>   
<!-- Fin -->
				...
				<hr>
                	<form method="post" name="form3" id="form3" action="procesos/procesos.php">
                        ...
                        <span class="add-on"><i class="icon-envelope"></i></span>
                               ...
                               <td height="50" align="center"><div class="input-prepend" style="margin-left:15%;">
                        <span class="add-on"><i class="icon-envelope"></i></span>
                               <input type="text" width="250px" id="txtTelefono" name="txtTelefono" placeholder="Telefono" /></div></td>
                              </tr>
