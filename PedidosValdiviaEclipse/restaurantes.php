  ...
  <br>
   <div class="menuaccion" style="position:static;"> <!-- FILTROS! -->
		...
		<form id="Filtros" name="Filtros" method="GET" action="">
         <div class="menucomplemento" style="margin-left:2%;">
         		Comidas:   
          ...
          <div class="menucomplemento" style="margin-left:1%;">
          		Valoración: 
                	<select id="Valor" name="Valor" style="width:95px;">
		   ...
		   <div class="menucomplemento" style="margin-left:1%;">
          		Tipo: 
                  <select id="Precio" name="Precio" style="width:100px;">
                   		<option id="Todos" name="Todos">Delivery</option>
            			<option id="Todos" name="Todos">No Delivery</option>
            	  </select>
          </div>
        ...
        <div class="menucomplemento" style="margin-left:3%;"> <!-- IMPORTANTE CAMBIAR -->
        	<div class="box">
     ...
     <div class="caja" style="width:614px; height:642px; margin-top:4.5%; border:1px solid #999;">
	  ...
	  if(isset($_GET["btnFiltro"]))
	  {
		  ...
		  else
		  {
			...
			?>
			<iframe src="<?php echo $row['Map']; ?>" width="614" height="550" frameborder="1" style="border:0" allowfullscreen></iframe>
			<?php
		  }
	  }
	  ...
	  {
		  ?>
          <iframe src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d6129.151108934684!2d-73.24416756241827!3d-39.8165116511323!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x9615ee70b10ceb9b%3A0x92cb4f523322282a!2sBeuchef+676%2C+Valdivia%2C+Regi%C3%B3n+de+los+R%C3%ADos!5e0!3m2!1ses!2scl!4v1443751614467" width="614" height="550" frameborder="1" style="border:0" allowfullscreen>
        </iframe>
          <?php
	  }
	  ?>
